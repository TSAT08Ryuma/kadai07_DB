        ...
        <div class="form-card">
            ...
            <form method="post" action="insert.php">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-input" placeholder="例：TokioMarin" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" class="form-textarea" placeholder="ご意見やご感想をお書きください..." required></textarea>
                </div>
